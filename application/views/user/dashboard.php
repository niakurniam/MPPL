            ...
            <div class="app" id="app">
                ...
                <footer class="footer">
                    ...
                    <div class="footer-block author">
                        <ul>
                            <li>  <a href="https://github.com/modularcode">Kelompok C-05</a> </li>
                            <li> <a href="https://github.com/modularcode/modular-admin-html#get-in-touch">Manajemen Proyek Perangkat Lunak</a> </li>
                        </ul>
                    </div>
                </footer>
