                        ...
                        <div class="row sameheight-container">
                            <div class="col-md-6">
                                <div class="card card-block sameheight-item">
                                    <div class="title-block">
                                        <h3 class="title"> Edit Anggota </h3>
                                    </div>
                                    <?php echo form_open('anggota_controller/save_edit_anggota'); ?>
                                    <?php echo form_hidden('nrp', $this->uri->segment(3));?>
                                        <div class="form-group"> <label class="control-label">NRP</label>
                                          <?php echo form_input ('NRP',$tangkap['NRP'],
                                          array('placeholder'=> 'NRP', 'class'=> 'form-control boxed', 'type'=>'text'));?>
                                        </div>
                                        <div class="form-group"> <label class="control-label">Nama</label>
                                            <?php echo form_input ('nama',$tangkap['nama'],
                                            array('placeholder'=> 'Nama anggota', 'class'=> 'form-control boxed', 'type'=>'text'))?>
                                        </div>
                                        <div class="form-group"> <label class="control-label">Role</label> <select class="form-control" name="id_role">
                                          <?php
                                              foreach ($role as $i){
                                                  echo "
                                                  <option value= $i->role> $i->nama_role </option>
                                                  ";
                                              }
