              ...
              <div class="row sameheight-container">
                <div class="col-md-6">
                  <div class="card card-block sameheight-item">
                    ...
                    <?php echo form_open('penilaian_controller/add_penilaian') ?>
                    ...
                    <div class="form-group"> <label class="control-label">Indikator</label>
                      <?php
                      $input_indikator=array('type'=>'text','name'=>'indikator','class'=>'form-control boxed','placeholder'=>'Indikator penilaian');
