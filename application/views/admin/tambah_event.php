                ...
                <ul class="nav metismenu" id="sidebar-menu">
                  ...
                  <li class="active">
                    ...
                    <ul>
                      ...
                      <li class="active"> <a href="<?php echo base_url(); ?>event_controller/tambah_event">
                        Tambah Event
                      </a> </li>
                      <li> <a href="">
                        Penilaian Event
                      </a> </li>
                      <li> <a href="<?php echo base_url(); ?>penilaian_controller/tambah_penilaian">
                        Tambah Penilaian
                      </a> </li>
                    </ul>
                  </li>
                ...
                <div class="col-md-6">
                  <div class="card card-block sameheight-item">
                    ...
                    <div class="form-group"> <label class="control-label">Nama Event</label>
                      <?php
                      $setting_nama_event=array('type'=>'text','name'=>'nama_event','class'=>'form-control boxed','placeholder'=>'Nama Kegiatan');
                    ...
                    <div class="form-inline">
                      ...
                      <?php
                      $setting_waktu_mulai=array('type'=>'time','name'=>'jam_mulai','class'=>'form-control','size'=>'4');
                      echo form_input($setting_waktu_mulai);
                      ?> - <?php $setting_waktu_selesai=array('type'=>'time','name'=>'jam_selesai','class'=>'form-control','size'=>'4');
