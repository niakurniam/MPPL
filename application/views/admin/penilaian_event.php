...
<head>
  ...
  <title> Penilaian Event | HMTCalendar </title>
        ...
        <aside class="sidebar">
          ...
          <article class="content static-tables-page">
            <div class="title-block">
              <h1 class="title"> Penilaian Event </h1>
            </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                foreach ($penilaian as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>".anchor('event_controller/edit_penilaian/'.$row->id_penilaian,'<center><i class="fa fa-pencil"></i></center>')."  </td>
                                                        <td>".anchor('event_controller/delete_penilaian/'.$row->id_penilaian,'<center><i class="fa fa-trash-o"></i></center>')."  </td>
                                                    </tr>
                                                    ";
                                                }
                                                 ?>
